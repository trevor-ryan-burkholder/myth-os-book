---
layout: page
title: "Resonance vector"
section: wiki
section_label: "Wiki"
permalink: /wiki/resonance-vector/
---

A specific symbol, image, character, piece of music, or memory that produces a genuine [Resonance](/wiki/resonance/) response, pointing toward internal material that cannot be reached directly.
...
Resonance vectors are not transferable. A symbol that hits for one person does not hit for another in the same way. The vector works because of alignment between the symbol and the specific internal structure it is connecting to. Importing someone else's vectors produces [Construction](/wiki/construction/) rather than [Detection](/wiki/detection/). The symbol becomes a label rather than an access route.

Across [years of practice](/wiki/symbolic-evolution/), resonance vectors shift. Symbols that produced strong responses early in the practice may produce quieter responses later. New symbols that previously registered as mild interest may begin producing genuine resonance. The system is pointing toward different territory because different territory has become relevant.

In [fragmented systems](/wiki/working-with-a-fragmented-system/), resonance vectors function as cross-state anchors. A vector that produces a strong response tends to produce that response across states, even when those states have no shared memory of having used it. The resonance operates at a level the dissociative system does not fully separate.

## Related

- [Resonance](/wiki/resonance/)
- [Archetype](/wiki/archetype/)
- [Symbolic evolution](/wiki/symbolic-evolution/)
- [Shadow](/wiki/shadow/) — the resonance category most associated with Jungian Shadow material
