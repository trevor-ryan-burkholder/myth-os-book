...
Not a [Presence](/wiki/presence/) but a state. The state that occurs when the primary presences in the system are operating in alignment rather than in conflict.
