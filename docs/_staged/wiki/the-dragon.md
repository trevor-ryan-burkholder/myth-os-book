...
section: wiki
section_label: "Wiki"
permalink: /wiki/the-dragon/
---

Not a [Presence]({{ '/wiki/presence/' | relative_url }}) but a state. The state that occurs when the primary presences in the system are operating in alignment rather than in conflict.
...
Chapter 15 (Copying Versus Discovering) introduces the Dragon as an example of an emergent system-level state.
